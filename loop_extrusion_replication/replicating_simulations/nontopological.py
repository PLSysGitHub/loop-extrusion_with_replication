...
def initModel(knockOffProb,kOriToTer_kTerToOri_kBypass,parSsites,\
    ...
    how likely to fall off at ter sites
    ...
    SMCTran = smcForkTranslocator(0, birthArray, deathArray, stallLeftArray, \
            stallRightArray, pauseArrayL, pauseArrayR, \
            stallDeathArray, kOriToTer_kTerToOri_kBypass,  smcNum, fork_rate,stallFork)
    return SMCTran

def run_simulation(monomer_size,monomer_wig, knockOffProb, kOriToTer_kTerToOri_kBypass, parSsites, wind, terSites,\
