from src.simulations_3D.replicating_no_smcs import run_simulation
...
def main():
    ...
    #1D simulation parameters. For replicating simulations, simulation time 1.1 * replication time
    total_time_min=int(bacterium.inferred_time(1.1*N))
