...
import pyximport; pyximport.install(
    ...
    reload_support=True)
from looplib_bacterial import replicating_bacterial_bypassing_fork_bypassing
...
def run_replicating_1D_sims(bacterium, num_smcs, burn_in_time_mins, sim_time_mins, num_sims, delta_t_sec=2, GPU=0, skip_gens=0):
    ...
    for i in range(num_sims+skip_gens):
        ...
        l_sites, r_sites, forks, ts = replicating_bacterial_bypassing_fork_bypassing.simulate(p, verbose=False) #perform a new simulation
